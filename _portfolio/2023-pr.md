...
This project develops a reproducible SQL pipeline for computing **question difficulty scores** for Problem Roulette.
...
## Step 2a. Student-level summary (level_student) tracks each student's attempts and performance by question.
