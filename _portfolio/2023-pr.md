...
Adaptive testing is a type of assessment where the difficulty of questions adjusts in real-time based on the test-taker's responses. With respect to user experience within Problem Roulette, adaptive testing enables students to optimize their personal study time, answering only the number of questions that benefit their own personal learning goals.
...
This project develops a reproducible SQL pipeline for computing **question difficulty scores** and **user mean difficulty** for Problem Roulette, an adaptive practice test delivery system used by thousands of students at the University of Michigan.
...
The pipeline scales to over 5,000 students and 30,000 assignment scores, making it essential for analytics, personalization, and identifying problematic questions.

---

## The Pipeline

Below is the **full SQL script** implementing all steps, with section headers for clarity.

```sql
/* ============================================
   Step 1. Prepare userQS Table (Filter Missing Responses)
   ============================================ */
...
/* ============================================
   Step 2a. Student-Level Summary (level_student)
   Tracks each student's attempts and performance by question.
   ============================================ */
...
/* ============================================
   Step 2b. Question-Level Summary (level_question)
   Aggregates attempts and accuracy across all students.
   ============================================ */
...
/* ============================================
   Step 2c. Course-Level Summary (level_course)
   Counts questions and unique users per course.
   ============================================ */
...
/* ============================================
   Step 3. Combine Levels (PR_level_sum)
   ============================================ */
...
/* ============================================
   Step 4a. Filter 1 – Minimum Attempts Per Question (≥10)
   ============================================ */
...
/* ============================================
   Step 4b. Filter 2 – Minimum Unique Users (≥10)
   ============================================ */
...
/* ============================================
   Step 4c. Filter 3 – Minimum Accuracy Threshold (≥25% correct)
   ============================================ */
...
/* ============================================
   Step 5. Merge Filters into userQS
   ============================================ */
...
/* ============================================
   Step 6a. Compute Question Difficulty (qdiff)
   ============================================ */
...
/* ============================================
   Step 6b. Compute User Mean Question Difficulty (user_mean_qdiff)
   ============================================ */
