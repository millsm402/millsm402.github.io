...
This SQL pipeline generates the difficulty and proficiency scores that power adaptive delivery. Click a step to jump to the code:

1. [Build raw dataset (userQS)](#step1)  
2. [Aggregate performance data](#step2)  
3. [Apply quality filters](#step3)  
4. [Compute difficulty and proficiency scores](#step4)  
5. [Output results for the adaptive engine](#step5)  
...
<div style="overflow:auto; max-height:400px; border:1px solid #ccc; padding:10px;">
...
<a name="step2"></a>
## Step 2. Create summary tables (student-, question-, and course-level)
...
<a name="step3"></a>
## Step 3. Merge summaries and apply quality filters

<details>
<summary>Click to view SQL</summary>
<div style="overflow:auto; max-height:600px; border:1px solid #ccc; padding:10px;">
...
<a name="step4"></a>
## Step 4. Compute difficulty and proficiency scores
...
<a name="step5"></a>
## Step 5. Output final difficulty scores
