...
## Step 2. Create summary tables that hold student-, question-, and course-level columns needed for defining filter thresholds.
...
## Step 3. Merge student-, question-, and course-levels summaries and then setup filters.
```sql
-- Merge summary data.
PR_level_sum AS (
  SELECT 
